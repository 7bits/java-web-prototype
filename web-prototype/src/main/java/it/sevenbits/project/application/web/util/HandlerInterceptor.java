...
import it.sevenbits.project.application.web.helper.CsrfResolver;
...
//            // User resolver
            // Shouldn't be instantiated for each request because SecurityContext have session scope
